...
# 绘制原始数据  
plt.plot(time_points[start_idx-10:end_idx+10]  ,log_energy[start_idx-10:end_idx+10]  , marker='o', markersize=1,label='Log-transformed Data')  # marker='o' 表示在每个数据点上画一个圆圈  
