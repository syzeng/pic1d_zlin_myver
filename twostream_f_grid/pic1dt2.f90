    ...
    real :: vmax=5.0 ,vbeam=4.0          !velocity space range [-vmax,vmax], f_m(v=5)=0.000003
    ...
    integer,parameter :: nspecie=2,nparticle=60000,nvelocity=128,nbeam=50000
    ...
    integer,parameter :: ntime=1000,ndiag=2,nmode=2
